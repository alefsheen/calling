  ...
  return (
    <div className="mx-auto p-2 bg-white">
        ...
        <table className="table-auto w-full text-left border-collapse">
          ...
          <thead>
            <tr className="bg-teal-700 text-white text-nowrap text-sm">
              ...
              <th className="pl-1 py-2 text-start">عملیات</th>
            </tr>
          </thead>
          {/* Body */}
          <tbody>
              ...
              <Fragment key={publisher._id}>
                ...
                >
                  ...
                  {visibleColumns.slice(0, 1).map((column, index) => (
                    <td
                      key={index}
                      className={`px-1 py-2 w-14 md:w-16 md:pr-2 ${
                        index > 1 && "text-start"
                      }`}
                    >
      ...
      <div className="mt-4 flex justify-center">
        ...
        >
          {loading ? "در حال بارگذاری..." : "↓ رویداد های بیشتر"}
        </button>
      </div>
