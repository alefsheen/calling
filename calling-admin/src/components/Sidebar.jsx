...
import { FaTags, FaUpload } from "react-icons/fa"; // Import icons from react-icons
...
const menuItems = [
  ...
  {
    href: "/presents",
    label: "گزارش حضورغیاب",
    icon: <FaTags className="w-5 h-5" />,
  },
  {
    href: "/callers1",
    label: "گزارش پیگیری قبل برنامه",
    icon: <FaTags className="w-5 h-5" />,
  },
  {
    href: "/callers2",
    label: "گزارش تماس به غایبین",
    icon: <FaTags className="w-5 h-5" />,
  },
  // {
  //   href: "/excel",
    ...
    <div className="h-screen flex flex-col">
      <header className="flex justify-between border-b-2 border-b-teal-500 bg-teal-950 text-white px-4 py-2 z-50">
        <div className="flex items-center gap-4">
          <h1 className="font-bold text-lg">سامانه پیگیری حضور</h1>
        </div>
        <button
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar */}
        <sidebar
          className={`fixed top-0 z-30 right-0 bg-teal-950 text-white transition-transform ${
